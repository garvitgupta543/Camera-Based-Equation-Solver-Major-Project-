...
% (1) Pre-processing of camera image
    ...
    % (1a) Read in image, rotate, convert to grayscale
        img = imread('C:\Users\Miffi\Dropbox\EE368 Project\Project Code\images\img.jpg');
        img = imrotate(img,-90);
        img = rgb2gray(img);
...
% (2) Dilation and Resizing
    ...
    % (2b) Resize image to 32x32
        ...
        imgBW = imgBW > 0.2;
        imwrite(imgBW,'C:\Users\Miffi\Dropbox\EE368 Project\Project Code\images\imgBW.jpg');
    
        %figure(3),imshow(imgBW,'InitialMagnification','fit');
    
% (3) Compute 64-vector, append to output training file
    % (3a) Open file for append
        fid = fopen('C:\Users\Miffi\Dropbox\EE368 Project\Project Code\images\NewData.txt', 'at');
