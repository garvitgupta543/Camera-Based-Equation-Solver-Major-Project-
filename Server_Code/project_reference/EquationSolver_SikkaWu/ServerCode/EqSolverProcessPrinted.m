function EqSolverProcessPrinted(input_img_path)
% function EqSolverProcess(input_img_path)
%
% 
%
% May 27, 2012
...
% Aman Sikka, Benny Wu
%
% Process Image and do OCR with Tesseract
...
% (1) VL_MSER
    try
        % Compute region seeds and elliptical frames
            [reg fr] = vl_mser(inputImg, 'MinDiversity', 0.7, 'MaxVariation', 0.4, 'Delta', 15, 'MaxArea', 0.1, 'MinArea', (50/(sizeImg(1)*sizeImg(2))) );
