...
import android.app.AlertDialog.Builder;
	...
	public class EqSolverActivity extends Activity  {
		...
		{			
			...
			HttpPost 	httpPost;
			if(iQueryType == 1) {
				httpPost 	= new HttpPost("http://10.33.83.227/EqSolverProcessWritten.php");
			}
			else {
				httpPost 	= new HttpPost("http://10.33.83.227/EqSolverProcessPrinted.php");
			}
		...
		SurfaceHolder.Callback surfaceCallback=new SurfaceHolder.Callback() {
			public void surfaceCreated(SurfaceHolder holder) {
				...
				try {
					...
					Toast
						.makeText(EqSolverActivity.this, t.getMessage(), Toast.LENGTH_LONG)
						.show();
				}
			}
